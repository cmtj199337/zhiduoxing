...
.sao-yi-sao-footer li.scan-qr-code div {
    background-image: url(/static/sao-yi-sao/scan-qr-code.png);
}
.sao-yi-sao-footer li.scan-qr-code.current div {
    background-image: url(/static/sao-yi-sao/scan-qr-code_hl.png);
}
.sao-yi-sao-footer li.scan-book div {
    background-image: url(/static/sao-yi-sao/scan-book.png);
}
.sao-yi-sao-footer li.scan-book.current div {
    background-image: url(/static/sao-yi-sao/scan-book_hl.png);
}
.sao-yi-sao-footer li.scan-street div {
    background-image: url(/static/sao-yi-sao/scan-street.png);
}
.sao-yi-sao-footer li.scan-street.current div {
    background-image: url(/static/sao-yi-sao/scan-street_hl.png);
}
.sao-yi-sao-footer li.scan-word div {
    background-image: url(/static/sao-yi-sao/scan-word.png);
}
.sao-yi-sao-footer li.scan-word.current div {
    background-image: url(/static/sao-yi-sao/scan-word_hl.png);
}
